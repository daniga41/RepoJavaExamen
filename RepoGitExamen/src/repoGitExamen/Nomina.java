...
public class Nomina implements InterfazNomina {
	...
	public byte getNumTrienios() {return numTrienios;}
	...
	public void setNumTrienios(byte trienios) {this.numTrienios = trienios;}
	...
	public static void main(String[] args) {
		...
		InterfazNomina ob = new Nomina(sueldoBase, trienios, 
						       jefe=='S'?true:false, 
						       casado=='S'?true:false,
						       numHijos);
